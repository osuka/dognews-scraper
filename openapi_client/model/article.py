...
class Article(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, url, status, target_url, title, description, thumbnail, last_updated, date_created, submitter, approver, *args, **kwargs):  # noqa: E501
